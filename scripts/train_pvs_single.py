...
def train():
    ...
    print("Loading train_single.npz...")
    data = np.load(PROCESSED_DIR / "train_single.npz")
    X, y = data['X'], data['y']
    ...
    # The preprocessor already output 6 channels (acc_x,y,z, gyro_x,y,z)
    # VelocityCNNSetC expects 6 channels
